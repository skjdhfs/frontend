...
function SelectionFrame(props: SelectionFrameProps) {
  ...
  return (
    <div className={styles.container} style={styleContainer} onClick={(e) => e.stopPropagation()}>
      ...
      <div
        onMouseDown={onTopLeft}
        className={`${styles.dot} ${styles.dotTopLeft} ${styles.dotCorner}`}
      ></div>
      <div
        onMouseDown={onTopRight}
        className={`${styles.dot} ${styles.dotTopRight} ${styles.dotCorner}`}
      ></div>
      <div
        onMouseDown={onBottomLeft}
        className={`${styles.dot} ${styles.dotBottomLeft} ${styles.dotCorner}`}
      ></div>
      <div
        onMouseDown={onBottomRight}
        className={`${styles.dot} ${styles.dotBottomRight} ${styles.dotCorner}`}
      ></div>
